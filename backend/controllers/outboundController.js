...
const Inventory = require("../models/Inventory");  // Assuming Inventory model
    ...
    try {
        ...
        for (let { product, quantity } of products) {
            ...
            await Product.findByIdAndUpdate(
                product,
                { $inc: { quantity: -quantity } }  // Decrease the stock by quantity
            );
...
exports.getProductsByWarehouse = async (req, res) => {
    ...
    try {
        // Cari produk yang tersedia di warehouse tertentu
        ...
        // Kirim daftar produk yang tersedia
